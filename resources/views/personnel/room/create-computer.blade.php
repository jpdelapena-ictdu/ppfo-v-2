...
@section('header')
    <section class="content-header">
      <h1>
        Items<small>Add item in the {{ $room->name }}.</small>
      </h1>
      <ol class="breadcrumb">
...
<div class="row">
  <div class="col-md-8 col-md-offset-2">
    ...
    @endif
      ...
      <form method="post" action="{{ route('room.personnel.store.computer', $room->id) }}" enctype="multipart/form-data">
      {!! csrf_field() !!}
      <div class="box">

        <div class="box-header with-border">
          <h3 class="box-title">Add a new item in the {{ $room->name }}</h3>
        </div>
