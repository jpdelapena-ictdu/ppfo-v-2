    ...
    <form method="post" id="create_form" enctype="multipart/form-data">
      ...
      <div class="box-footer">
       <div class="border-top">
        <div class="card-body">
          <button type="submit" class="btn btn-success btn-sm" form="create_form" formaction="{{ route('excess.personnel.component.store') }}"><i class="glyphicon glyphicon-floppy-disk"></i> Submit</button>
          <button type="submit" class="btn btn-success btn-sm" form="create_form" formaction="{{ route('excess.personnel.component.store.new') }}"><i class="glyphicon glyphicon-floppy-saved"></i> Submit And New</button>
        </div>
      </div>
    </div>
  </div><!-- /.box-footer-->
